      ...
      <Box className="mainFrame">
        ...
        <Box className="histories">
          <Box className="histories__inner">
            ...
            <p>
              «Читайте наш блог, чтобы найти лучшие советы и рекомендации, а
              также отзывы других пользователей»
            </p>
            <Box className="histories__block">
              ...
              <Box className="readmore_text">
                <p>
                  ...
                  составлялись детьми для отправки Санта-Клаусу, а хитрые
                  взрослые могли таким образом точно исполнить желания ребенка.
                </p>
